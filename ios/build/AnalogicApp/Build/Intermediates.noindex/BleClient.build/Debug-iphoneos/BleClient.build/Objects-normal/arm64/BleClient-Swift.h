...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BleClient",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9BleClient16BleClientManager")
...
SWIFT_PROTOCOL("_TtP9BleClient24BleClientManagerDelegate_")
@protocol BleClientManagerDelegate
- (void)dispatchEvent:(NSString * _Nonnull)name value:(id _Nonnull)value;
@end


SWIFT_CLASS("_TtC9BleClient8BleEvent")
...
@interface CBCentralManager (SWIFT_EXTENSION(BleClient))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end


@interface CBCharacteristic (SWIFT_EXTENSION(BleClient))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end


@interface CBDescriptor (SWIFT_EXTENSION(BleClient))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end


@interface CBPeripheral (SWIFT_EXTENSION(BleClient))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end


@interface CBService (SWIFT_EXTENSION(BleClient))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end
...
@interface CBUUID (SWIFT_EXTENSION(BleClient))
@property (nonatomic, readonly, copy) NSString * _Nonnull logDescription;
@end
